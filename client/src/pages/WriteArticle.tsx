...
const WriteArticle = () => {
  ...
  const articleLength: articleLengthType[] = [
    {
      length: 800, 
  ...
  const [selectedLength, setSelectedLength] = useState<articleLengthType>(articleLength[0]);
  ...
  return (
    ...
    gap-4 text-slate-700">
        ...
        border-gray-200">
          ...
          rounded-md border border-gray-300" placeholder="The future of artificial intelligence is ..." required value={input}/>
